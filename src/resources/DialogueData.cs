...
public partial class DialogueData : Resource
{
    ...
    [Export] public Array<ConditionData> Condition { get; set; } = new();

    [Export] public Array<QuestData> Quest { get; set; } = new();

    [Export] public AnswerType Answer { get; set; } = AnswerType.Positive;
}